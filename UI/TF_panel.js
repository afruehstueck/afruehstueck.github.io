...
TF_panel.prototype.addContextMenu = function( options ) {
	...
	var panelContextMenu = new ContextMenu( { container: container } );
...
TF_widget.prototype.createAnchor = function() {
	...
	function showContextMenu( e ) {
		...
		var widgetContextMenu = new ContextMenu( { container: container } );
		var menuItems = [
...
TF_widget.prototype.addControlPoint = function( value, alpha, color ) {
	...
	function showContextMenu( e ) {
		...
		var handleContextMenu = new ContextMenu( { container: container } );
		var menuItems = [
